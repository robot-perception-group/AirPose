...
###############
cam0_FOCAL_LENGTH = [3602,3615]
cam1_FOCAL_LENGTH = [3602,3615]
IMG_SIZE = [2448,2048]
CX0 = 1208
CY0 = 992
CX1 = 1208
...
class aircapData_crop(Dataset):
    ...
    def __getitem__(self,idx):
        ...
        bb0 = np.array([np.min(j2d0[:,:2],axis=0).astype("int")-50,np.max(j2d0[:,:2],axis=0).astype("int")+50])
        bb1 = np.array([np.min(j2d1[:,:2],axis=0).astype("int")-50,np.max(j2d1[:,:2],axis=0).astype("int")+50])
        bb0[bb0<0] = 0
        bb1[bb1<0] = 0
        ...
        smpl_joints_2d0 = j2d0[al_map2smpl,:]
        smpl_joints_2d1 = j2d1[al_map2smpl,:]
        smpl_joints_2d0[al_map2smpl==-1,:] = 0
        smpl_joints_2d1[al_map2smpl==-1,:] = 0
        smpl_joints_2d0 = torch.from_numpy(smpl_joints_2d0).unsqueeze(0)
        smpl_joints_2d1 = torch.from_numpy(smpl_joints_2d1).unsqueeze(0)
        ...
        gt_joints_2d_crop0 = copy.deepcopy(smpl_joints_2d0)
        gt_joints_2d_crop0[0,:,:2] = s0*(smpl_joints_2d0[0,:,:2] - (bb0 + 1)*intr0[:2,2])
        gt_joints_2d_crop1 = copy.deepcopy(smpl_joints_2d1)
        gt_joints_2d_crop1[0,:,:2] = s1*(smpl_joints_2d1[0,:,:2] - (bb1 + 1)*intr1[:2,2])
        ...
        'smpl_joints_2d0':smpl_joints_2d0.float(),'smpl_joints_2d1':smpl_joints_2d1.float(),
        'smpl_joints_2d_crop0':gt_joints_2d_crop0.float(),'smpl_joints_2d_crop1':gt_joints_2d_crop1.float(),
